...
class Client:
    ...
    def search_film_with_keyword(self, keyword: str, limit: int = 10, off_set: int = 0) -> List[Dict[str, Any]] | None:
        """
    ...
    def show_all_categories(self) -> List[Dict[str, Any]] | None:
        """
    ...
    def minimal_year_for_film(self) -> List[Dict[str, Any]] | None:
        """
    ...
    def maximal_year_for_film(self) -> List[Dict[str, Any]] | None:
        """
    ...
    def search_film_by_category(self, category: str, limit: int = 10, off_set: int = 0) -> List[Dict[str, Any]] | None:
        """
    ...
    def search_film_by_year(self, year: int, limit: int = 10, off_set: int = 0) -> List[Dict[str, Any]] | None:
        """
    ...
    def search_film_by_years_range(self, year_min: int, year_max: int, limit: int = 10, off_set: int = 0) -> List[Dict[str, Any]] | None:
        """
